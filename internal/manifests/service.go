...
func buildServicePlan(
	...
	return ServicePlan{
		Name:      SharedServiceName(ctx.BoxType, serviceComponent, numa),
		BoxType:   ctx.BoxType,
...
// Service is owned by the cluster-scoped YanetConfig singleton rather than a
// particular Yanet installation.
