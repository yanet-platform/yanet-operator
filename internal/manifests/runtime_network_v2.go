...
func WithRuntimeNetwork(ctx BuildContextV2, config *api.YanetConfigSpec, spec *api.YanetSpec) (BuildContextV2, error) {
...
// ConfigureRuntimeNetworkV2 injects runtime endpoints only for managed host configs.
// Configuration data remains opaque; unrelated host volumes do not enable overrides.
func ConfigureRuntimeNetworkV2(deployment *appsv1.Deployment, ctx BuildContextV2, component *helpers.ResolvedComponent) error {
...
func configureRuntimeContainer(deployment *appsv1.Deployment, ctx BuildContextV2, component *helpers.ResolvedComponent, composed bool) error {
...
func serviceEndpoint(ctx BuildContextV2, name string, port int32) string {
