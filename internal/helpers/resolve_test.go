...
func fixtureConfig() *yanetv1alpha1.YanetConfigSpec {
	return &yanetv1alpha1.YanetConfigSpec{
		Images: yanetv1alpha1.ImagesSpec{Registry: "registry.example/test", Prefix: "edge"},
		Components: yanetv1alpha1.ComponentsSpec{
			Controlplane: yanetv1alpha1.ControlplaneSpec{
				Image: yanetv1alpha1.ImageRef{Name: "controlplane", Tag: "v2.1"},
				Numa:  Int32Ptr(2),
			},
			Dataplane: yanetv1alpha1.DataplaneSpec{
				Image:     yanetv1alpha1.ImageRef{Name: "dataplane", Tag: "v2.1"},
				Hugepages: &yanetv1alpha1.Hugepages{Size: "1Gi", Count: 8},
				Sidecars: []yanetv1alpha1.SidecarSpec{
					{Name: "netlink-dataplane-sidecar", Image: yanetv1alpha1.ImageRef{Name: "netlink-dataplane-sidecar", Tag: "v2.1"}},
					{Name: "bird", Image: yanetv1alpha1.ImageRef{Name: "bird", Tag: "2.15"}},
				},
			},
			BirdAdapter: &yanetv1alpha1.BirdAdapterComp{
				Image: yanetv1alpha1.ImageRef{Name: "bird-adapter", Tag: "v0.3"},
			},
			Operators: []yanetv1alpha1.OperatorSpec{
				{
					Name: "antiddos",
					Containers: []yanetv1alpha1.OperatorContainer{
						{Name: "operator", Image: yanetv1alpha1.ImageRef{Name: "antiddos-operator", Tag: "v0.5"}},
						{Name: "agent", Image: yanetv1alpha1.ImageRef{Name: "antiddos-agent", Tag: "v0.5"}},
					},
				},
				{
					Name: "route",
					Containers: []yanetv1alpha1.OperatorContainer{{
						Name: "route", Image: yanetv1alpha1.ImageRef{Name: "route-operator", Tag: "v0.4"},
					}},
				},
				{Name: "announcer", Containers: []yanetv1alpha1.OperatorContainer{{Name: "announcer", Image: yanetv1alpha1.ImageRef{Name: "announcer", Tag: "v0.2"}}}},
			},
		},
		...
		BoxTypes: []yanetv1alpha1.BoxType{
			{
				...
				Components: yanetv1alpha1.BoxComponents{
					Controlplane: &yanetv1alpha1.BoxComponent{Patches: []string{"telegraf", "cp-resources"}},
					Dataplane: &yanetv1alpha1.BoxDataplane{
						Patches: []string{"telegraf"},
						Sidecars: map[string]yanetv1alpha1.BoxDataplaneSidecar{
							"bird": {}, "netlink-dataplane-sidecar": {},
						},
					},
				},
				Operators: map[string]yanetv1alpha1.BoxOperator{"announcer": {}},
			},
			{
				Name: "firewall",
				Components: yanetv1alpha1.BoxComponents{
					Controlplane: &yanetv1alpha1.BoxComponent{},
					Dataplane: &yanetv1alpha1.BoxDataplane{Sidecars: map[string]yanetv1alpha1.BoxDataplaneSidecar{
						"bird": {}, "netlink-dataplane-sidecar": {},
					}},
					BirdAdapter: &yanetv1alpha1.BoxComponent{},
				},
				Operators: map[string]yanetv1alpha1.BoxOperator{
...
func TestResolveBoxComponent_Hardcoded(t *testing.T) {
	config := fixtureConfig()
	yanet := &yanetv1alpha1.YanetSpec{BoxType: "release"}
...
func TestResolveBoxComponent_Operator(t *testing.T) {
	...
	operator, err := ResolveBoxComponent(
		config,
		&yanetv1alpha1.YanetSpec{BoxType: "firewall"},
		KindOperator,
		"antiddos",
	)
	if err != nil {
...
func TestResolveBoxComponent_Overrides(t *testing.T) {
	...
	yanet := &yanetv1alpha1.YanetSpec{
		...
		Components: &yanetv1alpha1.YanetComponentsOverride{
			...
			BirdAdapter: &yanetv1alpha1.YanetComponentOverride{
				Containers: map[string]yanetv1alpha1.YanetContainerOverride{
					yanetv1alpha1.BirdAdapterContainerName: {Tag: "hotfix"},
				},
			},
			Operators: map[string]yanetv1alpha1.YanetComponentOverride{
				"antiddos": {Containers: map[string]yanetv1alpha1.YanetContainerOverride{
					"operator": {Tag: "v0.5.1"},
					"agent":    {Tag: "v0.5.2"},
				}},
			},
...
func TestResolveBoxComponent_DataplaneSidecarEnablement(t *testing.T) {
	...
	box.Components.Dataplane.Sidecars["bird"] = yanetv1alpha1.BoxDataplaneSidecar{Enabled: PtrFalse()}
	yanet := &yanetv1alpha1.YanetSpec{BoxType: "release"}
	...
	yanet.Components = &yanetv1alpha1.YanetComponentsOverride{
		Dataplane: &yanetv1alpha1.YanetDataplaneOverride{
			Sidecars: map[string]yanetv1alpha1.YanetContainerOverride{
...
func TestResolveBoxComponent_MixedRegistryPalette(t *testing.T) {
	...
	yanet := &yanetv1alpha1.YanetSpec{BoxType: "firewall"}
	dataplane, err := ResolveBoxComponent(config, yanet, KindDataplane, "")
	if err != nil {
		t.Fatalf("resolve dataplane: %v", err)
	}
...
func TestResolveBoxComponent_Errors(t *testing.T) {
	...
	if _, err := ResolveBoxComponent(config, &yanetv1alpha1.YanetSpec{BoxType: "ghost"}, KindControlplane, ""); err == nil {
